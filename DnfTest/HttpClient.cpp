...
int CHttpClient::ExecuteRequest(LPCTSTR strMethod, LPCTSTR strUrl,LPCTSTR strHeaders, LPCTSTR strPostData, string &strResponse)
{
    CString strServer;
    CString strObject;
    DWORD dwServiceType;
...
int CHttpClient::HttpGet(LPCTSTR strUrl,LPCTSTR strHeaders, LPCTSTR strPostData, string &strResponse)
{
