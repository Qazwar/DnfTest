...
struct ClientContext
{
    SOCKET				m_Socket;
	// Store buffers
	CServerBuffer				m_WriteBuffer;
	CServerBuffer				m_CompressionBuffer;	// 接收到的压缩的数据
	CServerBuffer				m_DeCompressionBuffer;	// 解压后的数据
	CServerBuffer				m_ResendWriteBuffer;	// 上次发送的数据包，接收失败时重发时用
