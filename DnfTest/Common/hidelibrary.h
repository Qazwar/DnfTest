...
DWORD WINAPI UnLoadLibrary(LPVOID lParam)
{
	  ...
	  try
	  {
		  //OutputDebugStringA("Debug:UnLoadLibrary Entry.");
...
DWORD WINAPI HideLibrary02(LPVOID lParam)
{
	  ...
	  try
	  {
		  //OutputDebugStringA("Debug:HideLibrary02 Entry.");
...
void HideLibrary(HMODULE hModule, LPVOID pCallBackAddr, LPVOID lParam)
{
	  try
	  {
		  //OutputDebugStringA("Debug:HideLibrary Entry.");
		  ...
		  if(hThread == NULL)
		  {
			  //OutputDebugStringA("Debug:CreateThread HideLibrary02 Failed.");
